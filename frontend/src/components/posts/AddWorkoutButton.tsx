            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogTrigger asChild>
                    <Button
                        ...
                        className={ buttonClassName || "w-fit sm:w-32 flex items-center justify-center"}
                    >
                        {loadingWorkouts ? (
                            <>
                            ...
                            <>
                                <Dumbbell size={16} />
                                <span
                                    className={propsClassName || "truncate max-w-[3rem] sm:max-w-[7rem]"}
                            ...
                            <>
                                <Dumbbell size={16} />
                                <span className={propsClassName || "hidden sm:inline"}>Add Workout</span>
                            </>
                        )}
                    </Button>
                </DialogTrigger>
                    ...
                    {loadingWorkouts ? (
                        ...
                        workouts.length >= 1 ? (
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-col justify-center gap-1">
                                                    ...
                                                    <div className="flex justify-between items-center w-full">
                                                        ...
                                                        <div
                                                            className="flex items-center gap-3 text-xs text-[var(--subhead-text)] absolute bottom-2 right-2"
                                                        >
                            ...
                            <div className="py-8 text-center text-sm text-muted-foreground">
                                You must create or like a workout to add it!
                            </div>
                        )
                    )}
                </DialogContent>
